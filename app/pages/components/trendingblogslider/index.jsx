...
const slides = [
    {
        ...
        title: "Digital Marketing v/s Traditional marketing",
        description:
    ...
    return (
        <div className="px-6 lg:px-8 mb-8 md:mb-6 ">
            ...
            <div className="py-12">
                ...
                <img src="/assets/techstacks.png" alt="techstacks" />


            </div>


            <h2 className="text-xl md:text-[38px] mt-8  font-semibold">Trending Blogs & News</h2>
            ...
            <div className="flex gap-3">
                <div className="w-1/2  transition-all duration-500 ease-in-out flex flex-col justify-center ">
                    ...
                    <h2 className=" text-xl md:text-4xl font-normal mb-4">{slides[activeIndex].title}</h2>
                    <p className="mb-3 text-[16px]">{slides[activeIndex].description}</p>
